...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <div className="text-xl font-medium mb-2">Connexion</div>
          <div className="text-sm text-gray-600 cypher">Utilisez votre matricule en majuscule comme Matricule et Mot de passe, et changer votre mot de passe à la première connexion.</div>
        </div>
