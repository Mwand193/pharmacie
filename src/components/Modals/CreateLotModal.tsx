...
// // components/Modals/CreateLotModal.tsx
// 'use client';
...
//   const [fabricants, setFabricants] = useState<Distributeur[]>([]);
...
//     setFabricants(data.filter(d => d.type_acteur === 'fabricant'));
//   };
...
//         fabricant_id: formData.fabricant_id ? parseInt(formData.fabricant_id) : undefined,
//       });
//       onSuccess();
//       onClose();
//       resetForm();
...
//       {/* Modal Content */}
//       <div className="flex min-h-full rounded-none  items-center justify-center p-4">
//         <div 
...
//                                 setSearchTerm('');
//                               }}
//                               className="w-full text-left px-4 py-3 border-b-2 border-gray-200 last:border-b-0 hover:bg-green-50 transition-colors"
//                             >
...
//                       onChange={(e) => setFormData({ ...formData, fabricant_id: e.target.value })}
//                       className="block w-full px-3 py-3 border  text-sm focus:border-green-600 focus:ring-0 bg-white"
//                     >
//                       <option value="">Sélectionner un fabricant</option>
//                       {fabricants.map((f) => (
//                         <option key={f.id} value={f.id}>
//                           {f.nom} {f.licence && `• Licence: ${f.licence}`}
//                         </option>
//                       ))}
//                     </select>
//                   </div>
...
//                         </div>
//                       </div>
//                       {formData.fabricant_id && (
//                         <div className="col-span-2">
//                           <span className="text-gray-600">Fabricant:</span>
//                           <div className="font-bold text-gray-900">
//                             {fabricants.find(f => f.id === parseInt(formData.fabricant_id))?.nom}
//                           </div>
//                         </div>
//                       )}
//                     </div>
